...
On contrary to the Python standard library version this modified version
trusts the CD offset value listed in the EOCD record and never adds the guessed
